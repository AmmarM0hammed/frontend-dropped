        ...
        <div class="w-full z-10 fixed top-0 bg-primary   h-full  overflow-hidden flex items-center justify-center ">
            <div class="flex flex-col  w-96  gap-10 items-center  ">
                <div class="flex flex-col items-center gap-2"> 
                    <img src="~/assets/images/logo.svg" class="max-w-24" />
                    <p class="text-3xl font-semibold text-white">ادارة التحكم</p>
                </div>
            ...
            <svg class="absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 204 04">
